    ...
    : QObject(parent)
{
    ...
    connect(connectorTargetThread, &QThread::finished, connectorTargetThread, &QObject::deleteLater);    QMetaObject::invokeMethod(connector, "onInit", Qt::BlockingQueuedConnection);
	...
	connect(protocolTargetThread, &QThread::finished, protocolTargetThread, &QObject::deleteLater);    QMetaObject::invokeMethod(protocol, "onInit", Qt::BlockingQueuedConnection);
