...
int SetDeviceWithL(int dobotId, bool isWithL)
{
    // 0. Parameter checking
...
int GetDeviceWithL(int dobotId, bool *isWithL)
{
    // 0. Parameter checking
    if (isWithL == NULL) {
        return DobotCommunicate_InvalidParams;
...
int GetDeviceTime(int dobotId, uint32_t *deviceTime)
{
    // 0. Parameter checking
    if (deviceTime == NULL) {
        return DobotCommunicate_InvalidParams;
...
int GetPoseL(int dobotId, float *l)
{
    // 0. Parameter checking
    if (l == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetAutoLevelingCmd(int dobotId, AutoLevelingCmd *autoLevelingCmd, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
...
int GetAutoLevelingResult(int dobotId, float *precision)
{
    // 0. Parameter checking
    if (precision == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetJOGLParams(int dobotId, JOGLParams *jogLParams, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
    if (jogLParams == NULL) {
        return DobotCommunicate_InvalidParams;
...
int GetJOGLParams(int dobotId, JOGLParams *jogLParams)
{
    // 0. Parameter checking
    if (jogLParams == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetPTPLParams(int dobotId, PTPLParams *ptpLParams, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
    if (ptpLParams == NULL) {
        return DobotCommunicate_InvalidParams;
...
int GetPTPLParams(int dobotId, PTPLParams *ptpLParams)
{
    // 0. Parameter checking
    if (ptpLParams == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetPTPJump2Params(int dobotId, PTPJump2Params *ptpJump2Params, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
...
int GetPTPJump2Params(int dobotId, PTPJump2Params *ptpJump2Params)
{
    // 0. Parameter checking
    if (ptpJump2Params == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetPTPWithLCmd(int dobotId, PTPWithLCmd *ptpWithLCmd, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
    if (ptpWithLCmd == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetPTPPOCmd(int dobotId, PTPCmd *ptpCmd, ParallelOutputCmd *parallelCmd, int parallelCmdCount, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
    if (ptpCmd == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetPTPPOWithLCmd(int dobotId, PTPWithLCmd *ptpWithLCmd, ParallelOutputCmd *parallelCmd, int parallelCmdCount, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
    if (ptpWithLCmd == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetCircleCmd(int dobotId, CircleCmd *circleCmd, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
    if (circleCmd == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetEMotorS(int dobotId, EMotorS *eMotorS, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
    if (eMotorS == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetColorSensor(int dobotId, bool enable, ColorPort colorPort)
{
    // 0. Parameter checking
...
int GetColorSensor(int dobotId, uint8_t *r, uint8_t *g, uint8_t *b)
{
    // 0. Parameter checking
...
int SetInfraredSensor(int dobotId, bool enable,InfraredPort infraredPort)
{
    // 0. Parameter checking
...
int GetInfraredSensor(int dobotId, InfraredPort port, uint8_t *value)
{
    // 0. Parameter checking
    if (value== NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetLRHandCalibrateValue(int dobotId, float lrHandCalibrateValue)
{
    // 0. Parameter checking
...
int GetLRHandCalibrateValue(int dobotId, float *lrHandCalibrateValue)
{
    // 0. Parameter checking
...
int UpdateFirmware(int dobotId, FirmwareParams *firmwareParams)
{
    // 0. Parameter checking
...
int SetFirmwareMode(int dobotId, FirmwareMode *firmwareMode)
{
    // 0. Parameter checking
...
int GetFirmwareMode(int dobotId, FirmwareMode *firmwareMode)
{
    // 0. Parameter checking
    if (firmwareMode == NULL) {
        return DobotCommunicate_InvalidParams;
...
int GetServoPIDParams(int dobotId, PID *pid)
{
    // 0. Parameter checking
    if (pid == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetServoPIDParams(int dobotId, PID *pid, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
    if (pid == NULL) {
        return DobotCommunicate_InvalidParams;
...
int GetServoControlLoop(int dobotId, uint8_t index, uint8_t *controlLoop)
{
    // 0. Parameter checking
    if (controlLoop == NULL) {
        return DobotCommunicate_InvalidParams;
...
int SetServoControlLoop(int dobotId, uint8_t index, uint8_t controlLoop, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
...
int SaveServoPIDParams(int dobotId, uint8_t index, uint8_t controlLoop, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
...
int SetLostStepParams(int dobotId, float threshold)
{
    // 0. Parameter checking
...
int SetLostStepCmd(int dobotId, bool isQueued, uint64_t *queuedCmdIndex)
{
    // 0. Parameter checking
